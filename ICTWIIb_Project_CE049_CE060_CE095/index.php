          ...
          <div class="row h-100 align-items-center">
            <div class="col-12">
              ...
              <div class="welcome-text">
                <h2 data-animation="fadeInUp" data-delay="100ms">Join Us Today</h2>
                <h5 data-animation="fadeInUp" data-delay="300ms">Please schedule a podcast post, to make it visible here.</h5>
                <div class="welcome-btn-group">
                  <a href="#" class="btn poca-btn m-2 ml-0 active" data-animation="fadeInUp" data-delay="500ms">Subscribe For A Month</a>
                  <a href="#" class="btn poca-btn btn-2 m-2" data-animation="fadeInUp" data-delay="700ms">Subscribe For 6 Months</a>
                </div>
              </div>
              <!-- Welcome Music Area -->
              <div class="poca-music-area mt-100 d-flex align-items-center flex-wrap" data-animation="fadeInUp" data-delay="900ms">
                ...
                <div class="poca-music-content">
                  <span class="music-published-date">March 31, 2021</span>
          ...
          <div class="row h-100 align-items-center">
            <div class="col-12">
              ...
              <div class="poca-music-area mt-100 d-flex align-items-center flex-wrap" data-animation="fadeInUp" data-delay="900ms">
                ...
                <div class="poca-music-content">
                  <span class="music-published-date">January 24, 2021</span>
          ...
          <div class="row h-100 align-items-center">
            <div class="col-12">
              ...
              <div class="poca-music-area mt-100 d-flex align-items-center flex-wrap" data-animation="fadeInUp" data-delay="900ms">
                ...
                <div class="poca-music-content">
                  <span class="music-published-date">December 7, 2020</span>
      ...
      <div class="row poca-portfolio">
        ...
        <div class="col-12 col-md-6 single_gallery_item entre wow fadeInUp" data-wow-delay="0.2s">
          ...
          <div class="poca-music-area style-2 d-flex align-items-center flex-wrap">
            ...
            <div class="poca-music-content text-center">
              <span class="music-published-date mb-2">November 9, 2020</span>
        ...
        <div class="col-12 col-md-6 single_gallery_item entre tutor wow fadeInUp" data-wow-delay="0.2s">
          ...
          <div class="poca-music-area style-2 d-flex align-items-center flex-wrap">
            ...
            <div class="poca-music-content text-center">
              <span class="music-published-date mb-2">August 26, 2020</span>
        ...
        <div class="col-12 col-md-6 single_gallery_item media wow fadeInUp" data-wow-delay="0.2s">
          ...
          <div class="poca-music-area style-2 d-flex align-items-center flex-wrap">
            ...
            <div class="poca-music-content text-center">
              <span class="music-published-date mb-2">August 11, 2020</span>
              <h2>Episode 203 - The Last Blockbuster</h2>
              <div class="music-meta-data">
              </div>
              <!-- Music Player -->
        ...
        <div class="col-12 col-md-6 single_gallery_item media wow fadeInUp" data-wow-delay="0.2s">
          ...
          <div class="poca-music-area style-2 d-flex align-items-center flex-wrap">
            ...
            <div class="poca-music-content text-center">
              <span class="music-published-date mb-2">December 9, 2020</span>
